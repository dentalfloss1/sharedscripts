...
if __name__ == '__main__':
    ...
    for point in uniquepointingfloat:
        ...
        if not bool(args.dataset) and not bool(args.srcid):
        ...
        if args.dumpbigarr:
            for d in datasetTOexamine:
                ...
                print(bigarr['dataset'])
                if d in bigarr['dataset']:
                    print('Now saving bigarr binary')
                    np.save(f'ds{d}pointra{point[0]}pointdec{point[1]}bigarr.npy',bigarr[(bigarr['dataset']==d)])
